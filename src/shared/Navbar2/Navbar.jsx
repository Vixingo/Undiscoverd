                      ...
                      <MDBDropdownMenu>
                        <MDBDropdownItem link>
                          <span
                            ...
                            onClick={() => navigate("/create-coach-profile")}>
                        ...
                        <MDBDropdownItem
                          link
                          onClick={() => navigate("/favourite-players")}>
                          <span className="inner_item">
                            {" "}
                        ...
                        <MDBDropdownItem
                          ...
                          <span className="inner_item">{watch}Watch list</span>
                        </MDBDropdownItem>
                        <MDBDropdownItem link>
                          <span
                            className="inner_item"
                ...
                : profiledata?.BussinessName} */}
                      ...
                      <MDBDropdownMenu>
                        <MDBDropdownItem link>
                          <span
                            className="inner_item"
                            onClick={() => navigate("/create-player-profile")}>
                            {profile_icon} Create Profile
                            {/* {Userdata.is_profile_complete
                              ? "MY profile"
                              : "Create Profile"} */}
